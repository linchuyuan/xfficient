...
<div class='nav' style="margin-bottom:3%">
...
<div class="center center_post" style="display:inline-block;position: absolute; top:40%; width: 95%">
<div class="greeting" style="margin-bottom:3%">
<h1 style="margin-bottom:3%;text-decoration: underline;font-family: 'Brush Script MT', cursive;font-size: 90px;font-style: normal;font-variant: normal;font-weight: 500;line-height: 26.4px;">PastryDora</h1>
<h1 style="font-family: Papyrus, fantasy;;font-style: normal;font-variant: normal;">Keep learning, keep pretty</h1>
</div>
...
<p style="display:inline-block;text-align:right;margin:0;position:relative;width:100%;color:DimGray;white-space:pre">&copy 2016 Xfficient. All rights reversed. |		<img class="quick_link" id="facebook_link" src="image/facebook_icon.png" style="position:absolute;bottom:0%;width:1em;height:1em;">		<img class="quick_link" id="ins_link" src="image/instagram.png" style="position:absolute;bottom:0%;width:1em;height:1em">		<img class="quick_link" id="sina_link" src="image/sina.png" style="position:absolute;bottom:0%;width:1em;height:1em">		<img class="quick_link" id="snapchat_link" src="image/snapchat.jpeg" style="position:absolute;bottom:0%;width:1em;height:1em;"></p>
</div>
</div>
<script>
	$("#snapchat_link").click(function(){ window.location.replace("http://www.danicaxu.com/login")});
	$("#faceboot_link").click(function(){ window.location.replace("http://www.google.com")});
	$("#sina_link").click(function(){ window.location.replace("http://www.baidu.com")});
	$("#ins_link").click(function(){ window.location.replace("http://www.bing.com")});
