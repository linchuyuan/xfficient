...
$(".img_right_click").bind("taphold", function (event) {
...
$(".img_right_click_icon").click(function (event) {
...
$(".img li").click(function(){
	...
	case "set_as_background":
        window.location.replace("/mobile_main/session/set_bak.php?target="+value);
        break;
	case "default_background":
        window.location.replace("/mobile_main/session/default_bak.php");
        break;	
        case "download":
