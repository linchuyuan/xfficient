...
<body>
	<?php session_start(); include 'session/function.php'; if(auto_logout()){ header("location: session/log_out.php"); exit;} ?>
	...
	<?php  foreach ( $file_list as $var){ 
			...
			<div id="div_<?php echo replace_space_dot($var);?>" data-role="popup" class = "popup">
                        <img id="img_<?php echo replace_space_dot($var);?>" src="/mobile_main/session/display.php?target=<?php echo $var;?>">
                        </div>
                                <script>
	...
	<?php }} ?>
		<div class = "file_browser" style="position: absolute; left:0; right:0; top:0; bottom:0; width:100%; height:100%;">
			<form action="/mobile_main/session/rename.php" method="post" id="rename_input">
			...
			<table>
			<tr><td valign="top"><img src="/icons/xfficient_back.png" style="width:30px;height:30px"></td><td><a href="session/session_pop.php">BACK</a></td><td align="Center">Last Modified</td><td align="center">Size</td><td align="right">Function</td></tr>
			<?php foreach ( $file_list as $var){ ?> 
			<?php if (is_image("$dir/$var")){ ?>
			<tr><td valign="top"><img src="/icons/xfficient_image.png" style="width:30px;height:30px"></td><td><a href="#<?php echo $var;?>" data-rel="popup" class="img_right_click" id = "<?php echo replace_space_dot($var);?>" data-value = "<?php echo $var ?>" ><?php echo $var; ?></a></td><td align="right"><?php ?></td><td align="center"><?php echo file_size("$dir/$var");?> </td><td><img class="drag_icon img_right_click_icon" id = "<?php echo replace_space_dot($var);?>_icon"  data-rel = "<?php echo replace_space_dot($var);?>" data-value = "<?php echo $var ?>" src="/icons/xfficient_dragdown" style="width:30px;height:30px"></td></tr>
			<?php }
			 elseif (is_txt("$dir/$var")){ ?>
                        <tr><td valign="top"><img src="/icons/xfficient_txt.png" style="width:30px;height:30px"></td><td><a href="#<?php echo $var;?>" data-rel="popup" class="txt_right_click" id = "<?php echo replace_space_dot($var);?>" data-value = "<?php echo $var ?>" ><?php echo $var; ?></a></td><td align="right"><?php ?></td><td align="center"><?php echo file_size("$dir/$var");?> </td><td><img class="drag_icon txt_right_click_icon" id = "<?php echo replace_space_dot($var);?>_icon"  data-rel = "<?php echo replace_space_dot($var);?>" data-value = "<?php echo $var ?>" src="/icons/xfficient_dragdown" style="width:30px;height:30px"></td></tr>
                        <?php }
			 elseif (is_doc("$dir/$var")){ ?>
                        <tr><td valign="top"><img src="/icons/xfficient_docx.png" style="width:30px;height:30px"></td><td><a href="#<?php echo $var;?>" class="doc icon_right_click" id = "<?php echo replace_space_dot($var);?>" data-value = "<?php echo $var ?>" data-rel="<?php echo "$dir/$var" ?>"><?php echo $var; ?></a></td><td align="center"><?php ?></td><td align="center"><?php echo file_size("$dir/$var");?> </td><td><img class="drag_icon icon_right_click_icon" id = "<?php echo replace_space_dot($var);?>_icon"  data-rel = "<?php echo replace_space_dot($var);?>" data-value = "<?php echo $var ?>" src="/icons/xfficient_dragdown" style="width:30px;height:30px"></td></tr>
                        <?php }
 			elseif (is_pdf("$dir/$var")){ ?>
                        <tr><td valign="top"><img src="/icons/xfficient_pdf.png" style="width:30px;height:30px"></td><td><a href="/mobile_main/session/display_pdf.php?filename=<?php echo $var;?>" class = "icon_right_click" id = "<?php echo replace_space_dot($var);?>" data-value = "<?php echo $var ?>" ><?php echo $var; ?></a></td><td align="right"><?php ?></td><td align="center"><?php echo file_size("$dir/$var");?> </td><td><img class="drag_icon icon_right_click_icon" id = "<?php echo replace_space_dot($var);?>_icon"  data-rel = "<?php echo replace_space_dot($var);?>" data-value = "<?php echo $var ?>" src="/icons/xfficient_dragdown" style="width:30px;height:30px"></td></tr>
                        <?php }
			elseif (is_video("$dir/$var")){ ?>
                        <tr><td valign="top"><img src="/icons/xfficient_video.png" style="width:30px;height:30px"></td><td><a href="#" class = "video icon_right_click" id = "<?php echo replace_space_dot($var);?>" data-value = "<?php echo $var ?>" data-rel="<?php echo "$dir/$var" ?>"><?php echo $var; ?></a></td><td align="right"><?php ?></td><td align="center"><?php echo file_size("$dir/$var");?> </td><td><img class="drag_icon icon_right_click_icon" id = "<?php echo replace_space_dot($var);?>_icon"  data-rel = "<?php echo replace_space_dot($var);?>" data-value = "<?php echo $var ?>" src="/icons/xfficient_dragdown" style="width:30px;height:30px"></td></tr>
                        <?php }
			elseif (is_audio("$dir/$var")){ ?>
                        <tr><td valign="top"><img src="/icons/xfficient_audio.png" style="width:30px;height:30px"></td><td><a href="#" class = "audio icon_right_click" id = "<?php echo replace_space_dot($var);?>" data-value = "<?php echo $var ?>" data-rel="<?php echo "$dir/$var" ?>"><?php echo $var; ?></a></td><td align="right"><?php ?></td><td align="right"><?php echo file_size("$dir/$var");?> </td><td><img class="drag_icon icon_right_click_icon" id = "<?php echo replace_space_dot($var);?>_icon"  data-rel = "<?php echo replace_space_dot($var);?>" data-value = "<?php echo $var ?>" src="/icons/xfficient_dragdown" style="width:30px;height:30px"></td></tr>
                        <?php }
                        elseif (is_zip("$dir/$var")){ ?>
                        <tr><td valign="top"><img src="/icons/xfficient_zip.png" style="width:30px;height:30px"></td><td><a href="#" class = "audio icon_right_click" id = "<?php echo replace_space_dot($var);?>" data-value = "<?php echo $var ?>" data-rel="<?php echo "$dir/$var" ?>"><?php echo $var; ?></a></td><td align="right"><?php ?></td><td align="right"><?php echo file_size("$dir/$var");?> </td><td><img class="drag_icon icon_right_click_icon" id = "<?php echo replace_space_dot($var);?>_icon"  data-rel = "<?php echo replace_space_dot($var);?>" data-value = "<?php echo $var ?>" src="/icons/xfficient_dragdown" style="width:30px;height:30px"></td></tr>
                        <?php }
			elseif (is_dir("$dir/$var")) { ?>
			<tr><td valign="top"><img src="/icons/xfficient_folder.png" style="width:30px;height:30px"></td><td><a href="session/session_push.php?push=<?php echo $var;?>" class = "icon_right_click" id = "<?php echo replace_space_dot($var);?>" data-value = "<?php echo $var; ?>"><?php echo $var; ?></a></td><td align="right"><?php echo "         "; ?></td><td align="right"><?php echo file_size("$dir/$var");?></td><td><img class="drag_icon icon_right_click_icon" id = "<?php echo replace_space_dot($var);?>_icon"  data-rel = "<?php echo replace_space_dot($var);?>" data-value = "<?php echo $var ?>" src="/icons/xfficient_dragdown" style="width:30px;height:30px"></td></tr>
			<?php }
                        else { ?>
		...
		<div class = "upload">
		<form action="/mobile_main/session/upload.php" method="post" enctype="multipart/form-data" >
